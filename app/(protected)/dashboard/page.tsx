...
import { LogOut, BookOpen, User, User2Icon, Loader } from 'lucide-react';
            ...
            <div className="flex items-center ">
              <div className='flex flex-col gap-1'>
                <h2 className="text-lg tracking- font-medium text-[#A1A9AF]">
                  Bienvenido, <br />
                  <span className='text-xl font-semibold text-[#020608]'>
                    {name}
                  </span>
                </h2>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="">
          <div className=" flex items-center justify-between ">
            ...
            <h3 className="text-sm font-medium text-gray-700">Tareas</h3>
            </div>
          </div>

          <div className="py-2">
            {tasksLoading ? 
            <div className="flex min-h-[50dvh] items-center justify-center bg-gray-50">
              <div className="text-gray-600">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-900 mx-auto mb-4"></div>
                Cargando...
              </div>
